...
This outlines how to propose a change to paqueteMeteo. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Lucas-Descalzo/paqueteMeteo", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://lucas-descalzo.github.io/paqueteMeteo/CODE_OF_CONDUCT.md).
